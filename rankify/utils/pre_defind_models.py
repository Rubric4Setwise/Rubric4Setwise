...
HF_PRE_DEFIND_MODELS ={
    ...
    'rank4gen': {
        'rank4gen-qwen3-8b': 'JohnnyFan/Rank4Gen-DPO-Qwen3-8B',
    },
    'setr': {
        'setr-qwen3-8b': 'JohnnyFan/SETR-Qwen3-8B',
        'setr-llama3.1-8b': 'meta-llama/Llama-3.1-8B-Instruct',
        'setr-mixtral': 'mistralai/Mixtral-8x7B-Instruct-v0.1',
    },
    'reasonrank': {
        'reasonrank-7b': 'Qwen/Qwen2.5-7B-Instruct',
        'reasonrank-8b': 'meta-llama/Llama-3.1-8B-Instruct',
        'reasonrank-32b': 'Qwen/Qwen2.5-32B-Instruct',
        'reasonrank-qwen3-8b': 'Qwen/Qwen3-8B',
        'reasonrank-32B': 'liuwenhan/reasonrank-32B',
    },
    'rankr1': {
        'rankr1-7b': 'ielabgroup/Rank-R1-7B-v0.1',
        'rankr1-14b': 'ielabgroup/Rank-R1-14B-v0.1',
        'setwise-sft-7b': 'ielabgroup/Setwise-SFT-7B-v0.1',
        'setwise-sft-14b': 'ielabgroup/Setwise-SFT-14B-v0.1',
    },
    'rank1': {
        'rank1-7b': 'jhu-clsp/rank1-7b',
        'rank1-32b': 'jhu-clsp/rank1-32b',
    },
    'rankk': {
        'rankk-32b': 'hltcoe/Rank-K-32B',
    },
    'rearank': {
        'rearank-7b': 'le723z/Rearank-7B',
    },
}
