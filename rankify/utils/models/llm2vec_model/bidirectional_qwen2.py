...
# In newer transformers (>=4.46), FlashAttention2 and Sdpa variants are merged into Qwen2Attention
try:
...
# Fallback: if all attention classes are the same (new transformers), use ModifiedQwen2Attention for all
if Qwen2FlashAttention2 is Qwen2Attention:
