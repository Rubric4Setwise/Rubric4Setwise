...
# In newer transformers (>=4.46), FlashAttention2 and Sdpa variants are merged into MistralAttention
try:
...
# Fallback: if all attention classes are the same (new transformers), use ModifiedMistralAttention for all
if MistralFlashAttention2 is MistralAttention:
