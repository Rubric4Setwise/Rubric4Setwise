...
# In newer transformers (>=4.46), FlashAttention2 and Sdpa variants are merged into GemmaAttention
try:
...
# Fallback: if all attention classes are the same (new transformers), use ModifiedGemmaAttention for all
if GemmaFlashAttention2 is GemmaAttention:
