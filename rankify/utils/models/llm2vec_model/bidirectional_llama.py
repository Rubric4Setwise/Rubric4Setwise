...
# In newer transformers (>=4.46), FlashAttention2 and Sdpa variants are merged into LlamaAttention
try:
...
# Fallback: if all attention classes are the same (new transformers), use ModifiedLlamaAttention for all
if LlamaFlashAttention2 is LlamaAttention:
