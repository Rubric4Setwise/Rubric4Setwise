...
from rankify.utils.models.rank_llm.data import RankingExecInfo, Request, Result
from rankify.utils.models.rank_llm.rerank import PromptMode, RankLLM
from tqdm import tqdm
...
class ListwiseRankLLM(RankLLM, ABC):
    ...
    def sliding_windows_batched(
        ...
        # Clamp window_size to actual document count to avoid skipping the loop
        # when window_size > (rank_end - rank_start)
        if window_size > (rank_end - rank_start):
